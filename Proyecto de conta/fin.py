    ...
    # Colores
    self.bg_color = "#d1cfe2" 
    self.fg_color = "#9cadce" 
...
def plot_table(self):
    ...
    tree = ttk.Treeview(self.table_frame, columns=('Concepto', 'Unidades', 'Ventas', 'Costos Variables', 'Margen de Contribución', 'Costos Fijos', 'Utilidad o Pérdida'), show='headings')
    ...
    start_units = self.breakeven_units - 2
