...
class BreakEvenApp:
    ...
    def plot_table(self):
        ...
        # Ajustes de columnas
        columns_widths = [100, 80, 120, 150, 150, 100]
    ...
    def plot_graph(self):
        ...
        ventas = units * self.price_value
        costos_variables = units * self.variable_cost_value
        utilidad_perdida = (ventas - costos_variables) - self.fixed_costs_value
        ...
        plt.axhline(y=self.fixed_costs_value, color='black', linestyle='--', label='Costos Fijos')
